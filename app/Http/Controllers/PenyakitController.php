...
class PenyakitController extends Controller
{
    ...
    {
        if($request->has('cari')){
            $data_penyakit =\App\penyakit::where('id_penyakit','LIKE','%'.$request->cari.'%')->orwhere('nama_penyakit','LIKE','%'.$request->cari.'%')->get();

        }else{
            $data_penyakit = \App\penyakit::all();
        }
    ...
    {
        $penyakit = \App\penyakit::find($id_penyakit);
