      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="/reservasi">Reservasi</a></li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<section class="content">
        <div class="row">
          ...
          <div class="card card-primary">
              ...
              <h3 class="card-title">Pendaftaran Reservasi</h3>
</div>
            ...
            <div class="form-group">
                <label for="exampleInputNamaBelakang1">Pasien</label>
                <input name="id_pasien" type="text" class="form-control" placeholder="" value="{{Auth::User()->id_users}}" readonly >
            ...
            <div class="form-check form-check-inline">
              ...
              <input class="form-check-input" type="radio" name="id_layanan" value="LYN02" checked>
              <label class="form-check-label form-check-inline" >
              Home Visit
              </label>
            </div>
            ...
            <div class="form-group">
                <label for="exampleFormControlSelect1"></label>
                            <select name="id_waktu_visit" class="form-control" placeholder="ID Layanan">
                                @foreach($layanan_homevisit as $waktu) 
                            <option value="{{$waktu->id_waktu}}">{{$waktu->waktu_mulai}} ---- {{$waktu->waktu_selesai}}</option>                       
                                @endforeach
                            </select>
            </div>
